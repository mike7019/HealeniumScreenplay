...
public class NewMeetingPage {
    ...
    public static final Target TXT_ORGANIZED_BY_FIELD = Target.the("location to select")
            .locatedBy("//input[@aria-owns='select2-results-9']");

    public static final Target TXT_ATTENDEE_BY_FIELD = Target.the("location to select")
            .locatedBy("//input[@aria-owns='select2-results-12']");
    public static final Target TXT_REPORTED_BY_FIELD = Target.the("location to select")
            .locatedBy("//input[@aria-owns='select2-results-10']");
